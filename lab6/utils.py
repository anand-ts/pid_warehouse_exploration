...
class PidController:
    ...
    def __init__(self):
        ...
        self.linear_kp = 0.2  # 5
        self.linear_ki = 0.01  # 5
        self.linear_kd = 0.0

        self.angular_kp = 0.01
    ...
    def linear_controller(self, pose, goal_point):
        ...
        linear_velocity = self.linear_kp * self.linear_error + self.linear_ki * self.integral_linear_error + self.linear_kd * derivative_linear_error
    ...
    def angular_controller(self, pose, waypoint):
        ...
        angular_velocity = (
            self.angular_kp * self.angular_error + self.angular_ki * self.integral_angular_error + self.angular_kd * derivative_angular_error
        )
